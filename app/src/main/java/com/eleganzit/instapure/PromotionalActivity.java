...
public class PromotionalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rc_promotional=findViewById(R.id.rc_promotional);

        progressDialog = new ProgressDialog(PromotionalActivity.this);
        ...
        rc_promotional.setLayoutManager(layoutManager);
        
        productInfoAdapter=new ProductInfoAdapter(arrayList,PromotionalActivity.this);
                ...
                if (response.isSuccessful()) {
                    if (response.body().getStatus().toString().equalsIgnoreCase("1")) {
                        if (response.body().getData() != null) {
                            ...
                            Toast.makeText(PromotionalActivity.this, "Promoted successfully", Toast.LENGTH_SHORT).show();

                        }
                    } else {

                        Toast.makeText(PromotionalActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                }
                else {

                    Toast.makeText(PromotionalActivity.this, "Server or Internet Error", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void videoFeedlist() {
        progressDialog.show();
        RetrofitInterface myInterface = RetrofitAPI.getRetrofit().create(RetrofitInterface.class);
        Call<VideoFeedResponse> call = myInterface.videoFeedlist("1","3","1");
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("1")) {
                        ...
                        if (response.body().getData() != null) {
                            ...
                            //rc_promotional.setAdapter(new ProductInfoAdapter(arrayList,PromotionalActivity.this));
    ...
    private void imageFeedlist() {
        //progressDialog.show();
        RetrofitInterface myInterface = RetrofitAPI.getRetrofit().create(RetrofitInterface.class);
        Call<ImageFeedResponse> call = myInterface.imageFeedlist("1","1");
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("1")) {
                        ...
                        if (response.body().getData() != null) {
                            ...
                            rc_promotional.setAdapter(productInfoAdapter);
    ...
    private void videoFeedlist2(int limit) {
        ...
        RetrofitInterface myInterface = RetrofitAPI.getRetrofit().create(RetrofitInterface.class);
        Call<VideoFeedResponse> call = myInterface.videoFeedlist(limit+"","3","1");
        call.enqueue(new Callback<VideoFeedResponse>() {
            @Override
            public void onResponse(Call<VideoFeedResponse> call, Response<VideoFeedResponse> response) {
    ...
    private void imageFeedlist2(int limit) {
        ...
        RetrofitInterface myInterface = RetrofitAPI.getRetrofit().create(RetrofitInterface.class);
        Call<ImageFeedResponse> call = myInterface.imageFeedlist(limit+"","1");
        call.enqueue(new Callback<ImageFeedResponse>() {
            @Override
            public void onResponse(Call<ImageFeedResponse> call, Response<ImageFeedResponse> response) {
                ...
                public void onClick(View view) {
                    ...
                    if(isAppInstalled("com.instagram.android")){
                        ...
                        else
                        {
                            ...
                            //Toast.makeText(context, "Cannot share youtube videos on Instagram", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
